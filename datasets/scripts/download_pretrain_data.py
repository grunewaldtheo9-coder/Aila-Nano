...
from datasets.scripts.clean_text import clean_corpus
from datasets.scripts.dedupe import dedupe_corpus
...
def main():
    ...
    if not args.skip_tinystories:
        ...
        docs = dedupe_corpus(docs, near_threshold=args.near_dedupe_threshold)
